...
def erstelle_html_wochenuebersicht(bedarf, murt, wplan, rolling, tages_info):
    ...
    html_out.append('<div class="dash-meta">Stand: {} &nbsp;&middot;&nbsp; <a href="../eingabe.html" style="color:#2E75B6;text-decoration:none;font-weight:600">&#9998; Lager eintragen</a></div>'.format(datetime.now().strftime("%d.%m.%Y %H:%M")))
